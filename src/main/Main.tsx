        ...
        <div className={style.mainBlock}>
            <div className={style.mainContainer}>
                <div className={style.text}>
                    ...
                    <p>Hello there! I'm Pavel, a front-end developer from Minsk. I'm specialized in creating dynamic and interactive web experiences. With a passion for crafting clean and efficient code, I transform design concepts into functional websites that captivate users.  </p>
